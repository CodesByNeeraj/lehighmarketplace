...
export default function AdminHomepage() {
    ...
    //get all listings from lehigh students
    useEffect(() => {
    ...
    return (
        <div className="min-h-screen bg-white text-[#1a1a1a]">
            ...
            <main className="max-w-6xl mx-auto px-6 py-10">
                <p className="text-sm text-gray-500 mb-6">Check items listed by Lehigh students</p>
                {/*weather widget*/}
                {weatherCondition && (
                ...
                {/*empty state*/}
                {!loading && !error && showListings.length === 0 && (
